	...
	public static void main(String[] args) {
		...
		if(Howenter==3) {
			...
			if (rock_room==1){
				...
				if ( rock[erved - 1] == 0) {
					rock[erved - 1] = 1;
//					Rentalgoods rg = new Rentalgoods(); //Amenities 클래스 am1은 이름을 지어줌
//					rg.status(seat); // am1 = amenities 클래스 안에 들어있는 status 값을 가져옴
					System.out.println();
					System.out.println("------------------------------------------------------------");
...
//		}
			...
			Answer_original.main_discount(args);
	...
	public static void main_discount(String[] args) {
		...
		for(;;) {
			if(a == 1) {
				Answer_original.main_card(args);                             // 카드로 이동.
				break;
			}else if(a == 2) {
				System.out.println("------------------------------------------------------------");
				try {												// 딜레이 넣음.
				...
				Answer_original.main_pay2(args);                             // pay(결제 수단 선택)의 두번째 메인으로 이동
				break;
			}else if(a == 3) {
				try {												// 딜레이 넣음.
				...
				System.out.println("\n확인이 완료되었습니다.");
				System.out.println("------------------------------------------------------------");
				Answer_original.main_pay(args);                                  // pay(결제 수단 선택)의 첫번째 메인으로 이동
				return;
	...
	public static void main_pay(String[] args) {                          // main1
		...
		if(a == 1) {
			Answer_original.main_card(args);                                       // card로 이동
		}else if(a == 2) {
			Answer_original.main_cash(args);                                       // cash로 이동
		}else {
			Answer_original.main_gift_card1(args);                            // gift_card의 첫번째 메인으로 이동
		}
	}
	...
	public static void main_card(String[] args) {
		...
		if(a == 1) {
			Answer_original.main_pay(args);                                       // pay 첫번째 메인으로 이동
		}else {
			try {												// 딜레이 넣음.
	...
	public static void main_gift_card1(String[] args){                   // main1
		...
		if(gift_cash_2 == total){
			...
			Answer_original.main_gift_card2(args);                       // gift_card 두번째 메인으로 이동
		}
